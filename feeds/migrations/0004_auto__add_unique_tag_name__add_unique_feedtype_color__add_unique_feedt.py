...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('feeds_tag', ['name'])

        # Adding unique constraint on 'FeedType', fields ['color']
        db.create_unique('feeds_feedtype', ['color'])

        # Adding unique constraint on 'FeedType', fields ['name']
        db.create_unique('feeds_feedtype', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'FeedType', fields ['name']
        db.delete_unique('feeds_feedtype', ['name'])

        # Removing unique constraint on 'FeedType', fields ['color']
        db.delete_unique('feeds_feedtype', ['color'])

        # Removing unique constraint on 'Tag', fields ['name']
        db.delete_unique('feeds_tag', ['name'])
