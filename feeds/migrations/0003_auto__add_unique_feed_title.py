...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Feed', fields ['title']
        db.create_unique('feeds_feed', ['title'])


    def backwards(self, orm):
        # Removing unique constraint on 'Feed', fields ['title']
        db.delete_unique('feeds_feed', ['title'])
