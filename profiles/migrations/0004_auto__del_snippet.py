...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'profiles_snippet')


    def backwards(self, orm):
        # Adding model 'Snippet'
        db.create_table(u'profiles_snippet', (
    ...
    models = {
        ...
        u'resources.resource': {
            ...
            'resource_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['resources.ResourceType']"}),
            'show': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'topics': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['resources.Topic']", 'symmetrical': 'False'}),
