...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_entry', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='entrys', to=orm['auth.User']),
                      keep_default=False)
    ...
    models = {
        ...
        'blog.entry': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entrys'", 'to': "orm['auth.User']"}),
